...
class SASRec(torch.nn.Module):
    def __init__(self, user_num, item_num, args):
        ...
        # NOTE: 수정
        with open("./sports_random_init/asin2id.txt", "r") as f:
            asin2id = dict()
            id2asin = dict()
            for line in f:
        ...
        self.txt_features = {}
        self.img_features = {}
        txt_dir = "./sports_random_init/txt_features"
        img_dir = "./sports_random_init/img_features"
        ...
        #     torch.nn.Linear(self.txt_dim + self.img_dim, self.args.hidden_units * 2),
        #     torch.nn.ReLU(),
        #     torch.nn.Linear(self.args.hidden_units * 2, self.args.hidden_units)
        # )
    ...
    def predict(self, user_ids, log_seqs, item_indices): # for inference
        ...
        torch.save({"user_ids": user_ids[0], "user_repr": final_feat.detach().cpu()}, f"./sports_random_init/user_repr/{user_ids[0]}.pt") # NOTE: 변경
