...
def parse_args():
    ...
    parser.add_argument('--early_stopping_patience', type=int, default=2, help='') # 7
    ...
    #train
    parser.add_argument('--data_path', nargs='?', default='data/', help='Input data path.') # /home/ww/Code/work5/MMSSL/data/
    ...
    parser.add_argument('--epoch', type=int, default=20, help='Number of epoch.')  #default: 1000
    ...
    parser.add_argument('--lr', type=float, default=0.0054, help='Learning rate.') # 0.00055 
    ...
    parser.add_argument('--weight_decay', default=0.014, type=float, help='for opt_D')  # 1e-4
