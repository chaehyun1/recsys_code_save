...
class Trainer(object):
    def __init__(self, data_config):
        ...
        self.image_feats = np.load(args.data_path + '{}/image_feat.npy'.format(args.dataset)) # image_feat.npy
        self.text_feats = np.load(args.data_path + '{}/text_feat_title_category.npy'.format(args.dataset))
    ...
    def train(self):
        ...
        }, f"checkpoint_final_epoch_{epoch}.pt")
        self.logger.logging(f"Model saved to checkpoint_final_epoch_title_category_{epoch}.pt")
