...
class Trainer(object):
    def __init__(self, data_config):
        ...
        image_feats = np.load(args.data_path + '{}/image_feat_50%.npy'.format(args.dataset))
        text_feats = np.load(args.data_path + '{}/text_feat_nounchunk_50%.npy'.format(args.dataset))
